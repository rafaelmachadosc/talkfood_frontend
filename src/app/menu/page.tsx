      ...
      <header className="bg-app-card border-b border-app-border sticky top-0 z-40">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <h1 className="text-2xl font-normal text-brand-primary tracking-tight">Cardápio Online</h1>
            <div className="flex items-center gap-2">
              {savedTable && savedPhone && (
                <Button
                  ...
                  variant="outline"
                  className="border-app-border hover:bg-gray-100 text-black tech-shadow tech-hover font-normal"
                >
              ...
              <Button
                ...
                className="bg-brand-primary hover:bg-brand-primary/90 text-black tech-shadow tech-hover font-normal relative"
              >
